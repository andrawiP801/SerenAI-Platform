...
class Command(BaseCommand):
    help = 'Actualiza las portadas y URLs de los libros en la base de datos'
    ...
    def handle(self, *args, **options):
        ...
        for book_data in books_data:
            try:
                ...
                self.stdout.write(self.style.SUCCESS(f"Actualizado: {book.title}"))
            except Book.DoesNotExist:
                self.stdout.write(self.style.WARNING(f"No encontrado: {book_data['title']} por {book_data['author']}"))